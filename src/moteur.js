// pour voir
  ...
  function waitPresentation() {
    setTimeout(redirectToPresentation, 4000)
  }

  function redirectToGalerie() {
      window.location.href="/Galerie";
  }

  function waitGalerie() {
    setTimeout(redirectToGalerie, 4000)
  }


  function redirectToExpertise() {
      window.location.href="/Expertise";
  }

  function waitExpertise() {
    setTimeout(redirectToExpertise, 4000)
  }

  function redirectToPalmares() {
      window.location.href="/palmares";
  }

  function waitPalmares() {
    setTimeout(redirectToPalmares, 4000)
  }   

  function redirectToLivredOr() {
      window.location.href="/livredor";
  }

  function waitLivredOr() {
    setTimeout(redirectToLivredOr, 4000)
  }
  ...
  function start() {
    ...
    loader.load('../src/models/moteur1.dae', onLoaded, onProgress, onError);
